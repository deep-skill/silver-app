...
class CreateTripScreen extends ConsumerWidget {
  ...
  const CreateTripScreen({super.key, required this.tripId});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final reserveState = ref.watch(reserveCreateUpdateProvider(tripId));
    final size = MediaQuery.of(context).size;
    return Scaffold(
      appBar: AppBar(
          backgroundColor: const Color(0xffF2F3F7),
          centerTitle: true,
          title: Text(tripId == 'new' ? "Crear Reserva" : "Editar Reserva")),
